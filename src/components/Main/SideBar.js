...
import inviktusLogo from '../../assets/invictusLogo.svg'
...
class SideBarContent extends PureComponent {
   ...
   render() {
      ...
      return (
        // do not remove style background color from here 32a466
        <PMColumn style={{ backgroundColor: '#1263a1' }}>
            <section className="pm-logo-section">
                <img src={ inviktusLogo} alt="INVIKTUS LOGO" height="47px"  />
            </section>
            <ListGroup variant="flush" className='pm-side-bar-list-group'>
